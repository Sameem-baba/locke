...
function TeamPage() {
    ...
    return (
        <div className="bg-gray-100 min-h-screen">
            ...
            <section className="flex pt-24 pb-10 md:pb-0 md:pt-0 min-h-screen w-full justify-center items-center relative px-6">
                <div className="container mx-auto text-center relative z-10">
                    ...
                    <p className="text-gray-600 mt-4 max-w-2xl mx-auto text-lg">
                        Great teams build great things! Meet the passionate minds driving our success.
                    </p>
                    {/* Team Grid */ }
            ...
            {/* Modal */ }
            { selectedMember && (
                <div className="fixed inset-0 flex items-center justify-center px-4 md:px-0 bg-black/70 z-50">
