...
const ComingSoon = () => {
    return (
        <div className="container mx-auto md:h-screen min-h-fit px-8 mt-20 md:mt-0 w-full flex flex-col text-black md:flex-row justify-between items-center">
            <div className="flex flex-col gap-5">
                ...
                <p className="text-base">&quot;Don&lsquo;t Worry we will not spam you .&quot;</p>
